...
const InputCard = () => {
  return (
    <div className="bg-[#c4e3e7]">
      <div className='bg-white w-[375px] pt-6 py-4 px-8 rounded-t-3xl text-sm text-[#0c494c] font-semibold'>
        ...
        <h2 className="my-5 pt-3">Select Tip %</h2>
        <div className="grid grid-cols-2 gap-4 text-white text-center text-2xl font-semibold  ">

...
const InformationCard = () => {
  return (
    <section className='font-space-mono bg-[#0c494c] h-[200px] flex flex-col items-center rounded-lg border-black p-5 m-6'>
        ...
        <button className="bg-[#30c1ad] text-[#0c494c] text-xl font-extrabold px-28 py-3 rounded-lg">RESET</button>
    </section>
  )
}
